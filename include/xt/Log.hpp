 ...
 * either instance of xt::Log or string, second one is
 * xt::LogLevel (for macro use DISABLE, ERROR, WARNING, INFO, DEBUG).
 * In case of xt::Log instance all log parameters are kept inside
 ...
 * @endcode
 *
 * Log with xt::Log instance:
 * @code
 * xt::Log myLog("MyModule");
 *
 ...
 * @param[in] instance log instance (xt::Log) or <i>const char*</i> or
 *                         <i>nullptr</i>
 * @param[in] level    log level
 * @ingroup log
 */
#define LOG(instance, level) \
	xt::LogLine().get(instance, __FILENAME__, __LINE__, \
							  xt::LogLevel::log ## level)
...
#define DLOG(instance, level) \
	true ? (void) 0 : xt::LogVoid() & LOG(instance, level)
